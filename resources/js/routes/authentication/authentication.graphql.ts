...
export type AuthenticateWithCodeMutation = { __typename?: 'Mutation', authenticateWithCode: { __typename?: 'AuthenticateWithCodeResponse', ok: boolean, message?: string | null, token?: string | null } };
